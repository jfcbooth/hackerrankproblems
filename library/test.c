...
int main()
{
    ...
    for(int i = 0; i < total_number_of_shelves; i++){
        total_number_of_books[i] = 0;
				total_number_of_pages[i] = malloc(MAX_BOOK_NUM * sizeof(int));
    }
    ...
    while (total_number_of_queries--) {
        ...
        if (type_of_query == 1) {
            ...
            total_number_of_books[x]++; // add to the total number of books on that particular shelf
